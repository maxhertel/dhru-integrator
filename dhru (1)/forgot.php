        ...
        <div class="block block-rounded mb-0">
          <div class="block-header block-header-default">
            ...
            <div class="block-options">
              <a class="btn-block-option" href="index.php" data-bs-toggle="tooltip" data-bs-placement="left" title="Sign In">
          ...
          <div class="block-content">
            <div class="p-sm-3 px-lg-4 px-xxl-5 py-lg-5">
              <h1 class="h2 mb-1">One Server</h1>
              ...
              <form class="js-validation-reminder mt-4" action="forgot.php" method="POST">
                <div class="mb-4">
                ...
                <div class="row mb-4">
                  <div class="col-md-6 col-xl-5">
                    <button type="submit" name="forgot-pass" class="btn w-100 btn-alt-primary">
