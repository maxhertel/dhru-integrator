<?php
/**
 * get_started/rtl_landing/views/inc_footer.php
 *
 * Author: pixelcave
 *
  ...
  <div class="content py-4">
    ...
    <div class="row items-push fs-sm border-bottom pt-4">
      <div class="col-sm-6 col-md-4">
        <h3>Category</h3>
        <ul class="list list-simple-mini pe-0">
          <li>
      ...
      <div class="col-md-4">
        ...
        <form class="push">
          <div class="input-group">
            <input type="email" class="form-control form-control-alt rounded-end" id="dm-gs-subscribe-email" name="dm-gs-subscribe-email" placeholder="Your email..">
            <button type="submit" class="btn btn-alt-primary rounded-start">Subscribe</button>
          </div>
        </form>
      </div>
    </div>
    ...
    <div class="row fs-sm pt-4">
      ...
      <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-end">
        <a class="fw-semibold" href="https://1.envato.market/AVD6j" target="_blank"><?php echo $one->name . ' ' . $one->version; ?></a> &copy; <span data-toggle="year-copy"></span>
      </div>
    </div>
