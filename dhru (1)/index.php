        ...
        <div class="block block-rounded mb-0">
          <div class="block-header block-header-default">
            ...
            <div class="block-options">
              <a class="btn-block-option fs-sm" href="forgot.php">Forgot Password?</a>
              <a class="btn-block-option" href="register.php" data-bs-toggle="tooltip" data-bs-placement="left" title="New Account">
              ...
              <form class="js-validation-signin" action="index.php" method="POST">
                ...
                <div class="row mb-4">
                  <div class="col-md-6 col-xl-5">
                    <button type="submit" name="signin" class="btn w-100 btn-alt-primary">
